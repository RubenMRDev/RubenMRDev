    ...
    <div className="mt-20">
      ...
      <p className="text-center text-white mt-4 text-4xl">
        <span className="block font-bold">
          <AnimatedLetters text={"Hey! I'm "} startDelay={0} delay={0.05} />
          <span className="inline-block text-[#b040b4]">
            <AnimatedLetters text={"Rubén"} startDelay={0.5} delay={0.05} />
          </span>
        </span>
        <span className="block font-bold text-3xl mt-2">
          <AnimatedLetters text={"Web Developer"} startDelay={1} delay={0.05} />
        </span>
      </p>
      <div className="mt-8 mx-4 md:mx-20 lg:mx-80 text-xl">
        <p className="text-[#C5C5C5]">
          ...
          , and I'm passionate about exploring new working methods. I'm always
          eager to learn something new and expand my skills in the ever-evolving
          world of technology.
        </p>
      </div>
